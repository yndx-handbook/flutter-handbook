...
### **Зачем это нужно** {#zachem-eto-nuzhno}
...
### **Взаимодействие компонент** {#vzaimodejstvie-komponent}

Разобрав основные компоненты представленного API Navigator 2.0, рассмотрим схему их взаимодействия.

![](https://yastatic.net/s3/education-portal/media/5_7_1_920d72d0ba.svg)
...
## **Пример реализации** {#primer-realizacii}
...
### **Конфигурация страницы** {#konfiguraciya-stranicy}
...
### **Состояние навигации** {#sostoyanie-navigacii}
...
### **Управление состоянием** {#upravlenie-sostoyaniem}
...
### **Инъекция зависимости** {#inuekciya-zavisimosti}
...
### **Делегат навигации** {#delegat-navigacii}
...
### **Навигация по приложению** {#navigaciya-po-prilozheniyu}
...
![](https://yastatic.net/s3/education-portal/media/5_7_2_25f5a36b76.svg)
...
![gif0.gif](https://yastatic.net/s3/education-portal/media/5_7_3_56ad2f4aaf.gif =x600)

### **Дополнительные возможности Navigator 2.0** {#dopolnitelnye-vozmozhnosti-navigator-20}
...
## **Достоинства и недостатки Navigator 2.0** {#dostoinstva-i-nedostatki-navigator-20}
...
## **Пакеты с pub.dev** {#pakety-s-pubdev}
