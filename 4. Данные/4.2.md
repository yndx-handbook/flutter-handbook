Ранее мы [разобрали](https://education.yandex.ru/handbook/flutter/article/networking-rabota-s-setyu-http-socket) основы клиент-серверного взаимодействия и научились работе со стандартным пакетом http.
...
[@](https://staff.yandex-team.ru/Query) QueryMap — позволяет добавлять мапу параметров запроса.
