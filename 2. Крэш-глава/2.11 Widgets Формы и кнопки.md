...
Виджет `TextField` имеет широкое API для кастомизации. Вы можете добавить `label`, `icon`, `hint` и текст при ошибки, использовав класс `InputDecoration` для свойства `decoration` у `TextField`.
...
![image_(2).png](https://yastatic.net/s3/ml-handbook/admin/image_2_967f10732e.png)
...
![21.svg](https://yastatic.net/s3/ml-handbook/admin/21_e9da59dca7.svg)
...
![2.svg](https://yastatic.net/s3/ml-handbook/admin/2_cb723fc653.svg)
...
![20.svg](https://yastatic.net/s3/ml-handbook/admin/20_8a57ccd960.svg)
...
![1.svg](https://yastatic.net/s3/ml-handbook/admin/1_04c4d91239.svg)
...
![Screen Recording 2023-07-10 at 00 (online-video-cutter.com) (2) (1).gif](https://yastatic.net/s3/ml-handbook/admin/Screen_Recording_2023_07_10_at_00_online_video_cutter_com_2_1_a6a4a33259.gif)
