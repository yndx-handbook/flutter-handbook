...
Для работы с текстовыми ассетами — к примеру, файлами `.txt` или `.json` — используется класс [`AssetBundle`](https://api.flutter.dev/flutter/services/AssetBundle-class.html).
