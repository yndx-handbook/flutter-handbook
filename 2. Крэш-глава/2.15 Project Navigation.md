...
Этот метод закрывает открытый экран, возвращая нас к предыдущему. Если вызвать этот метод на главной странице, то мы увидем чёрный экран, так как в нашем приложении не останется открытых экранов. Иными словами, стек навигации станет пустым.
...
![fluttern_1.7.3_2.svg](https://yastatic.net/s3/ml-handbook/admin/fluttern_1_7_3_2_f643ff6e27.svg)
...
- **`Navigator.pushNamed()`**: Этот метод переходит на новый экран, используя имя маршрута из в таблицы маршрутизации см. далее.
